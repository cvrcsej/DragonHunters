var sketchProc = function(processingInstance) {
     with (processingInstance) {
        ...
        var scene;
        var dragonEntranceTime = 0;
        var dragonEntrance = true;
        var entranceDuration = 120; // frames for entrance animation
        ...
        var Dragon = function() {
            ...
            this.drawRightWing = function() {
                ...
                //3rd spine
                line(   this.wing.x3, this.wing.y3,
                        this.wing.spines.c.x1, this.wing.spines.c.x1);
        ...
        draw = function() {
            ...
            switch(scene.page) {
                ...
                case "go":
                    ...
                    if(dragonEntrance && dragonEntranceTime < entranceDuration) {
                        var progress = dragonEntranceTime / entranceDuration;
                        scene.dragon.y = 600 - (progress * 400); // Move from bottom to center
                        dragonEntranceTime++;
                        
                        // Trigger flame at midpoint
                        if(progress > 0.4 && progress < 0.6 && !scene.dragon.flameActive) {
                            scene.dragon.flameActive = true;
                            scene.dragon.flameTriggerFrame = frameCount;
                            triggerFlame(scene.dragon.x + 65, scene.dragon.y - 50);
                        }
                    } else if(dragonEntranceTime >= entranceDuration) {
                        dragonEntrance = false;
                        scene.dragon.y = 200; // Final position
                    }
